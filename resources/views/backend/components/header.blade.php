                                             ...
                                             <div class="row">
                                                  <div class="col">
                                                       <a class="text-body" href="#">
                                                            <div class="d-flex">
                                                                 <img src="/assets/base/images/avatar/avatar-1.jpg"
                                                                      alt=""
                                        ...
                                        <li class="list-group-item">
                                             <div class="row">
                                                  <div class="col">
                                                       <a class="text-body" href="#">
                                                            <div class="d-flex">
                                                                 <img src="/assets/base/images/avatar/avatar-2.jpg"
                                                                      alt=""
                                                                      class="avatar-md rounded-circle">
                                                                 <div class="ms-3">
                                        ...
                                        <li class="list-group-item">
                                             <div class="row">
                                                  <div class="col">
                                                       <a class="text-body" href="#">
                                                            <div class="d-flex">
                                                                 <img src="/assets/base/images/avatar/avatar-3.jpg"
                                                                      alt=""
                                                                      class="avatar-md rounded-circle">
                                                                 <div class="ms-3">
                                        ...
                                        <li class="list-group-item">
                                             <div class="row">
                                                  <div class="col">
                                                       <a class="text-body" href="#">
                                                            <div class="d-flex">
                                                                 <img src="/assets/base/images/avatar/avatar-4.jpg"
                                                                      alt=""
                                                                      class="avatar-md rounded-circle">
                                                                 <div class="ms-3">
                         ...
                         <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownUser">
                              <div class="dropdown-item">
                                   <div class="d-flex">
                                        <div class="avatar avatar-md avatar-indicators avatar-online">
                                             <img alt="avatar"
                                                  src="/assets/base/images/avatar/avatar-1.jpg"
                                                  class="rounded-circle">
                                        </div>
                                        <div class="ms-3 lh-1">
