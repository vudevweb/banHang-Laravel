                        ...
                        <div class="row gx-3">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <select class="form-select" aria-label="Default select example" id="role" name="role">
                                    ...
                                    <option @if (old('role') == "user") selected @endif value="user">Khách hàng</option>
                                    <option @if (old('role') == "admin") selected @endif value="admin">Quản trị viên</option>
                                </select>
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row gx-3">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <select class="setupSelect2 form-select province location" aria-label="Default select example"
                                    id="province_id" name="province_id" data-target="districts">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <select class="setupSelect2 form-select districts location" aria-label="Default select example"
                                    id="district_id" name="district_id" data-target="wards">
