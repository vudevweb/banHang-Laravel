...
@section('page')
    ...
    <form class="row" form action="{{ route('admin.post.update', $post -> id) }}" method="POST">
        @csrf
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3 col-md-12">
                        ...
                        <select name="post_category_id" id="post_category_id" class="form-select setupSelect2">
                            ...
                            @foreach ($postCategories as $post_category)
                                <option {{ $post_category->id == $post->post_category_id ? 'selected' : '' }}
                                    value="{{ $post_category->id }}">{{ $post_category->title }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="mb-3 col-md-12">
                        ...
                        <select name="publish" id="publish" class="form-select">
                            ...
                            <option {{ $post->publish == 1 ? 'selected' : '' }} value="1">Hiện</option>
                            <option {{ $post->publish == 0 ? 'selected' : '' }} value="0">Ẩn</option>
                        </select>
                    </div>
                    ...
                    <div class="mb-3 col-md-12">
                        ...
                        <img src="{{ $post->thumbnail }}" class="img_demo img-fluid image-target" width="100%"
                            alt="">
                    </div>
